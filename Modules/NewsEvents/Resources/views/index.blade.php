...
<ol class="m-0 border-0 breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('newsevent.index') }}">NewsEvents</a></li>
    <li class="breadcrumb-item">List</li>
</ol>
@can('Add NewsEvent')
<button class="float-right p-2 mb-2 btn btn-sm btn-primary" style="margin-top:10px"
    onclick="window.location='{{ route('newsevent.create') }}'">Add
    NewsEvents</button>
@endcan
@endsection
@section('content')
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header"><i class="fa fa-align-justify"></i> NewsEvents</div>
                <div class="card-body">
                    <table class="table table-responsive-sm table-bordered table-striped table-sm">
                        ...
                        <tbody >
                            ...
                            <tr data-id="{{$new->id}}">
                                ...
                                <td>
                                    <img src="{{Storage::url($new->image)}}" height="100">
                                </td>
                                ...
                                <td>
                                    ...
                                    onclick="window.location=`{{ route('newsevent.edit',['id'=>$new->id]) }}`">Edit</button>
                                    <button data-question="Are you sure to delete the data?" data-toggle="confirm" data-id="{{ $new->id }}" class="btn btn-xs btn-danger">Delete</button>
                                </td>
                            </tr>
                            @empty
                            <tr>
                        ...
                        <div class="team">
                            <div class="row">
                                ...
                                <div class="team-title col-sm-6">
                                    <img src="{{Storage::url($new->image)}}" height="200">
                                </div>
                            </div>
                            <div class="details">
                                <div class="staus">
                                ...
                                <div class="action d-flex">
                                    <div class="p-3 edit"
                                        onclick="window.location=`{{ route('newsevent.edit',['id'=>$new->id]) }}`">
                                        <i class="fas fa-edit"></i>
                                    </div>
                                    <div class="p-3 delete" data-toggle="confirm" data-id="{{ $new->id }}">
...
<script>
    $(function(){
        $('[data-toggle="confirm"]').jConfirm().on('confirm', function(e){
            var btn = $(this),
            id = btn.data('id');
            var url = '{{ route("newsevent.delete", ":id") }}';
