...
<button class="float-right p-2 mb-2 btn btn-sm btn-primary" style="margin-top:10px"
    onclick="window.location='{{ route('approach.create') }}'">Add Approach</button>
@endcan
@endsection
@section('content')
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header"><i class="fa fa-align-justify"></i> Approach </div>
                <div class="card-body">
                        ...
                        <tbody >
                            ...
                            <tr data-id="{{$approach->id}}">
                                ...
                                <td>
                                    ...
                                    onclick="window.location=`{{ route('approach.edit',['id'=>$approach->id]) }}`">Edit</button>
                                    <button data-question="Are you sure to delete the data?" data-toggle="confirm" data-id="{{ $approach->id }}" class="btn btn-xs btn-danger">Delete</button>
                                </td>
                            </tr>
                            @empty
                            <tr>
                    ...
                    {{ $approaches->links('pagination::bootstrap-4') }}
                </div>
...
<script>
    $(function(){
        $('[data-toggle="confirm"]').jConfirm().on('confirm', function(e){
            var btn = $(this),
            id = btn.data('id');
            var url = '{{ route("approach.delete", ":id") }}';
