...
<button class="float-right p-2 mb-2 btn btn-sm btn-primary" style="margin-top:10px"
    onclick="window.location='{{ route('slider.create') }}'">Add
    Slider</button>
@endcan
@endsection
@section('content')
