...
<ol class="m-0 border-0 breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('publicationCategory.index') }}">Publication Category</a></li>
    <li class="breadcrumb-item">List</li>
</ol>
@can('Add IECCBCC')
<button class="float-right p-2 mb-2 btn btn-sm btn-primary" style="margin-top:10px"
    onclick="window.location='{{ route('publicationCategory.create') }}'">Add
...
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header"><i class="fa fa-align-justify"></i>Publication Category</div>
                <div class="card-body">
                    <table class="table table-responsive-sm table-bordered table-striped table-sm">
                        ...
                        <tbody >
                            @forelse ($publicationCategories as $key=>$category)
                            <tr data-id="{{$category->id}}">
                                ...
                                <td>
                                    ...
                                    onclick="window.location=`{{ route('publicationCategory.edit',['id'=>$category->id]) }}`">Edit</button>
                    ...
                    {{ $publicationCategories->links('pagination::bootstrap-4') }}
                </div>
...
<script>
    $(function(){
        $('[data-toggle="confirm"]').jConfirm().on('confirm', function(e){
            var btn = $(this),
            id = btn.data('id');
            var url = '{{ route("publicationCategory.delete", ":id") }}';
