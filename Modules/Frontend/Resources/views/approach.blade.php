...
<section class="upcoming-events-wrap section-padding">
    <div class="container">
        ...
        <div class="row grid" style="position: relative; height: 1025px;">
            @foreach($approaches->where('category','approaches') as $project)
            ...
            @foreach($approaches->where('category','strategies') as $project)
                ...
                <div class="single-event-ticket row align-items-center">
                    ...
                    <div class="col-xl-5 pr-xl-0">
                        <div class="event-info">
                            ...
                            <p></p>
                            <p><span style="color: rgb(114, 116, 117); font-family: Roboto, sans-serif; font-size: 18px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incidid unt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in repreh enderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</span></p>
                            <p></p>
                        </div>
                    </div>
                    <div class="col-xl-3 text-xl-right">
