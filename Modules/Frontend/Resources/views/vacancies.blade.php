...
<section class="page-banner-wrap bg-cover sameoverlay" style="background-image: url('{{Storage::url(@$dashboard_site->vacancy_banner)}}')">
                            ...
                            <div class="post-content">
                                ...
                                <p>{!! $vacancy->description !!}</p>
                                 <div class="d-flex justify-content-between align-items-center mt-30">
                                    ...
                                    <div class="post-link">
                                        <a href="{{ Storage::url('public/vacancy/'.$vacancy->file) }}" target="_blank"><i class="fal fa-download"></i> Download</a>
                                    </div>
                                </div>
                            </div>
                        </div>
