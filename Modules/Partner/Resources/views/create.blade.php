                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" class="form-control" value="{{ old('name') }}" placeholder="Enter Partner Title">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="location">Location </label>
                                    <input name="location" class="form-control" value="{{ old('location') }}" placeholder="Enter Location">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" id="category" name="category">
                                        ...
                                        <option value="consortium">Consortium Partners</option>
                                        <option value="implementing">Implementing Partners</option>
                                    </select>
                                </div>
                            </div>
