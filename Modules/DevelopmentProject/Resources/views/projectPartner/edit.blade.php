    ...
    <div class="fade-in">
        <div class="row">
            <div class="col-lg-6">
                ...
                @endif
                <form method="post" action="{{ route('projectpartner.update',$projectPartner->id) }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="title" class="form-control" value="{{ $projectPartner->title }}">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="description">Description</label>
                                        <textarea name="description" class="form-control">{{ $projectPartner->description }}
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    $projectPartner->publish?'checked':'' }}>
                                </div>
                            </div>
