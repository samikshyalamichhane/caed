...
<ol class="m-0 border-0 breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('materialCategory.index') }}">Material Category</a></li>

</ol>
@can('Add IECCBCC')
<button class="float-right p-2 mb-2 btn btn-sm btn-primary" style="margin-top:10px"
    onclick="window.location='{{ route('materialCategory.create') }}'">Add
...
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header"><i class="fa fa-align-justify"></i>Material Category</div>
                <div class="card-body">
                    <table class="table table-responsive-sm table-bordered table-striped table-sm">
                        ...
                        <tbody >
                            @forelse ($materialCategories as $key=>$category)
                            <tr data-id="{{$category->id}}">
                                ...
                                <td>
                                    ...
                                    onclick="window.location=`{{ route('materialCategory.edit',['id'=>$category->id]) }}`">Edit</button>
                    ...
                    {{ $materialCategories->links('pagination::bootstrap-4') }}
                </div>
...
<script>
    $(function(){
        $('[data-toggle="confirm"]').jConfirm().on('confirm', function(e){
            var btn = $(this),
            id = btn.data('id');
            var url = '{{ route("materialCategory.delete", ":id") }}';
